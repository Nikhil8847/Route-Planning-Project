...
```
git clone https://github.com/Nikhil8847/Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:Nikhil8847/Route-Planning-Project.git --recurse-submodules
```
